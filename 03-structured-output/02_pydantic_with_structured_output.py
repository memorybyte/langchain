...
class Review(BaseModel):
    key_themese: list[str] = Field(description='List down all the key themes discussed in the review in a list')
    ...
    cons: Optional[list[str]] = Field(default=None, description='Write the name of the reviewer')
